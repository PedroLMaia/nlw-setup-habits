...
import { ProgressBar } from "../components/ProgressBat";
...
export function Habit() {
    ...
    async function fetchHabits() {
        try {
            ...
            console.log(error);
            Alert.alert('Ops', 'Nao foi possivel carregar as informacoes dos hábitos.')
        }
        finally {
            setLoading(false)
        }
    ...
    async function handleToggleHabit(habitId: string) {
        try {
            ...
            console.log(error);
            Alert.alert('Ops','Nao foi possivel atualizar o status do hábito');
        }
    }
